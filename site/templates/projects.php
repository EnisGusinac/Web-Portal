        ...
        <div class="col-md-8">
            <div class="entity_wrapper">
                ...
                <div class="entity_thumb">
                    <img class="img-responsive" src="<?php snippet('showcase') ?>" alt="feature-top">
                </div>
                <!-- entity_thumb -->

                <div class="entity_title">
                    <a href="single.html" target="_blank"><h3> <?= $page->title()->html() ?> </h3></a>
                </div>
                <!-- entity_title -->
        ...
        <div class="col-md-4">
            ...
            <div class="widget reviews m30">
                ...
                <div class="media">
                    ...
                    <div class="media-body"><h3 class="media-heading"><a href="single.html" target="_blank">Samsung is
                                the best
