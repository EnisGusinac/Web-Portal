            ...
            <div class="col-md-8">
                <div class="entity_wrapper">
                    <div class="entity_title">
                        <h1><a href="#"> <?= $page->title()->html() ?> </a></h1>
                    </div>
                    <!-- entity_title -->

                    <div class="entity_meta"><a href="#" target="_self">
                            <?= $page->date('F jS, Y') ?>
                        </a>, by: <a href="#" target="_self">Eric
                            joan</a>
                    </div>
                    <!-- entity_meta -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
                                    <a href="single.html" target="_self"><h3 class="media-heading">Fully new look slim
                                            handset
                                            like</h3></a>
                                    <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
